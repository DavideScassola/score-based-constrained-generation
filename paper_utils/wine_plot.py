...
for path in tqdm.tqdm(paths):
    ...
    if (
        os.path.isfile(path + "/report/no_guidance.csv")
        and os.path.isfile(path + "/report/guidance.csv")
        and os.path.isfile(path + "/report/rejection_sampling.csv")
    ):
        ...
        axes[-2].legend(labels=["No guidance", "Rej. samp.", "Guidance"])
